...
public class Computer {
   ...
   public Computer(){           //constructors are always public
       super();                 //implicilty calls the constructor of the parent class that is the object class
   }
   //we can have multiple constructors in the class
